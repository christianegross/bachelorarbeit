...
%
\usepackage[backend=biber, style=numeric, sorting=none, eprint=false]{biblatex}
...
%Text und Bilder nebeneinander
\usepackage{wrapfig}
%Zwei Bilder nebeneinander, als Alternative zu minipage:
\usepackage{subcaption}

%bessere Darstellung von gnuplot?
\usepackage{epstopdf}
