...
%	Fehler kommen durch Autokorrelation der Daten, sind also Temperaturabhängig: Beseitigung der Autokorrelation durch Blocking der Daten, also Einteilen in verschiedene Blöcke der Länge $l$, danach Bootstrapping, um Fehlerqualität zu verbessern. (Zitat?)
	...
	\begin{figure}[htbp]
		\begin{minipage}{0.48\textwidth}
			\include{Bilder/akzeptanzrategrob}
		\end{minipage}
		\begin{minipage}{0.48\textwidth}
			\input{Bilder/akzeptanzratefein}
		\end{minipage}
	...
	\begin{figure}[htbp]
		\begin{minipage}{0.48\textwidth}
			\include{Bilder/hamiltoniangrob}
		\end{minipage}
		\begin{minipage}{0.48\textwidth}
			\input{Bilder/hamiltonianfein}
		\end{minipage}
...
%	\end{verbatim}
	...
	\begin{figure}[htbp]
		\begin{minipage}{0.48\textwidth}
			\include{Bilder/magnetisierunggrob}
		\end{minipage}
		\begin{minipage}{0.48\textwidth}
			\input{Bilder/magnetisierungfein}
		\end{minipage}
